...
SRC_URI="ftp://ftp.rz.uni-wuerzburg.de/pub/unix/kde/stable/amarok/2.0.1/src/amarok-2.0.1.tar.bz2"
...
src_configure() {
	...
	# for mysql-pic
	export LD_LIBRARY_PATH=/opt/mysql-5.0.72-r1-pic/lib/mysql
	export CMAKE_LIBRARY_PATH=/opt/mysql-5.0.72-r1-pic/lib/mysql:$CMAKE_LIBRARY_PATH
	export CMAKE_INCLUDE_PATH=/opt/mysql-5.0.72-r1-pic/include/mysql:$CMAKE_INCLUDE_PATH
