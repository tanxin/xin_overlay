...
# $Header: /var/cvsroot/gentoo-x86/net-ftp/proftpd/proftpd-1.3.1_rc2-r1.ebuild,v 1.3 2007/05/13 15:09:53 armin76 Exp $

inherit eutils flag-o-matic toolchain-funcs autotools

KEYWORDS="~alpha ~amd64 ~hppa ~mips ~ppc ppc64 ~sparc x86"

IUSE="acl authfile clamav hardened ifsession ipv6 ldap mysql ncurses nls
noauthunix opensslcrypt pam postgres radius rewrite selinux shaper sitemisc
softquota ssl tcpd vroot xinetd iconv"
...
SRC_URI="ftp://ftp.proftpd.org/distrib/source/${P/_/}.tar.bz2
		iconv? ( http://proftpd.nowboy.com/${PN}-mod-iconv-${ICONV_VER}.patch )
...
src_unpack() {
	...
	epatch "${DISTDIR}/${PN}-mod-iconv-${ICONV_VER}.patch"
	eautoconf
